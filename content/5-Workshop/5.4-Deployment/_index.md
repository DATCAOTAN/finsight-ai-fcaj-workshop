...
*Figure: The two-pass SAM and frontend publication sequence across the local workstation and AWS. Select the image to view it at full size.*
...
{{% notice warning %}}
Run all commands from the FinSight AI application repository, not from this report repository. Keep the application worktree clean and never save active stack outputs or provider keys in Git.
{{% /notice %}}
